...
const STEP_TO_PSEUDO = [
  ...
  { match: "Enqueue(Open", key: "init-open" },
  ...
  // =========================
  // THÊM VÀO CLOSE (mark when dequeue)
  // =========================
  { match: "Close.Add", key: "add-close" },
  ...
  // =========================
  // ENQUEUE VÀO OPEN (FIFO)
  // =========================
  { match: "Enqueue '", key: "push" },

  // =========================
  // KẾT QUẢ CUỐI
  // =========================
  { match: "Thứ tự duyệt BFS", key: "result" }
