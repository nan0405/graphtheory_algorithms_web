...
//   { match: "For t ∈ V: Prev[t] := None; Dist[t] := ∞; ", key: "init-dist" },
//   { match: "] = 0", key: "init-start" },
//   { match: "Open := ∅; put(", key: "init-open" },
//   { match: "t := get(min(Dist[Open])) := ", key: "pick-min" },
//   { match: "Append(Close,", key: "add-close" },
//   { match: "thêm vào Open", key: "for" },
//   { match: "For e ∈ Open", key: "for" },
