...
let nodes = [
  { id: "a", x: 500, y: 130, _fixed: true },
  { id: "b", x: 350, y: 250, _fixed: true },
  { id: "c", x: 650, y: 250, _fixed: true },
  { id: "d", x: 270, y: 350, _fixed: true },
  { id: "e", x: 400, y: 350, _fixed: true },
  { id: "f", x: 600, y: 350, _fixed: true },
  { id: "g", x: 730, y: 350, _fixed: true },
  { id: "h", x: 210, y: 500, _fixed: true },
  { id: "i", x: 350, y: 500, _fixed: true },
  { id: "j", x: 710, y: 500, _fixed: true },
];

let links = [
  { source: "a", target: "b", weight: 1, id: "a-b" },
  { source: "a", target: "c", weight: 1, id: "a-c" },

  { source: "b", target: "d", weight: 1, id: "b-d" },
  { source: "b", target: "e", weight: 1, id: "b-e" },

  { source: "c", target: "f", weight: 1, id: "c-f" },
  { source: "c", target: "g", weight: 1, id: "c-g" },

  { source: "d", target: "h", weight: 1, id: "d-h" },
  { source: "d", target: "i", weight: 1, id: "d-i" },

  { source: "g", target: "j", weight: 1, id: "g-j" },
];
...
async function runDijkstra() {
  ...
  try {
    ...
    // 2️⃣ Gọi DFS (chỉ start)
    const runResp = await fetch(
      `${SERVER_BASE}/api/graphs/${id}/dfs?start=${startInput}`
    );

    if (!runResp.ok)
      throw new Error("Run DFS failed");
...
const STEP_TO_PSEUDO = [
  ...
  // BƯỚC 1 – KHỞI TẠO
  // =========================
  { match: "Close := {}", key: "init-open" },
  { match: "Push(Open", key: "init-open" },

  // =========================
  // LẤY ĐỈNH RA KHỎI OPEN
  // =========================
  { match: "khỏi Open", key: "pop" },

  // =========================
  // KIỂM TRA ĐÃ THĂM
  // =========================
  { match: "∈ Close → Bỏ qua", key: "check" },

  // =========================
  // THÊM VÀO CLOSE
  // =========================
  { match: "Đánh dấu", key: "add-close" },

  // =========================
  // XÉT DANH SÁCH KỀ
  // =========================
  { match: "neighbors(", key: "neighbors" },

  // =========================
  // XÉT TỪNG ĐỈNH KỀ
  // =========================
  { match: "Xét đỉnh kề", key: "neighbors" },
  ...
  // KẾT QUẢ CUỐI
  // =========================
  { match: "Thứ tự duyệt DFS", key: "result" }
